...
function logBackground(level, message) {
    if ('logging' in forge.config && forge.config.logging.console === true) {
...
var apiImpl = {
    ...
    request: {
        ...
        ajax: function(params_, success, error) {
            /**
             * Use jQuery.ajax for IE8 (fixes failing Ajax GET requests) and use
             * the forge custom Ajax implementation for IE9+.
             *
             * Uses a test for the document.addEventListener, which was added in IE9
             */
